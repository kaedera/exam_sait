...
const AuthPage = () => {
  ...
  return (
    <div className={`${darkMode ? 'dark' : ''} flex flex-col min-h-screen bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 font-poppins transition-colors duration-500`}>      
      <Header title={greeting ? `${greeting}, пользователь!` : "ГБПОУ НСО «Новосибирский авиационный технический колледж имени Б.С. Галущака»"} className="text-white drop-shadow-lg flex justify-between items-center">
        <button 
